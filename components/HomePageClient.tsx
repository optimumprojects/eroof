          ...
          <div className="text-center max-w-4xl mx-auto text-white space-y-8">
            ...
            <div className="py-12">
              <Button asChild size="lg" variant="cta">
                <Link href="/quote" onClick={() => { window.dataLayer = window.dataLayer || []; window.dataLayer.push({ event: 'cta_quote', site_section: document.title.split('|')[0].trim(), site_sub_section: 'hero' }); }}>
      ...
      <section className="py-16 bg-secondary">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            <Button asChild size="lg" variant="cta">
              <Link href="/quote" onClick={() => { window.dataLayer = window.dataLayer || []; window.dataLayer.push({ event: 'cta_quote', site_section: document.title.split('|')[0].trim(), site_sub_section: 'See Why Homeowners Love eRoof.ca' }); }}><Calculator className="h-5 w-5" />Get A Real Quote In Minutes!</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-16 bg-white">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            <Button asChild size="lg" variant="cta">
              <Link href="/quote" onClick={() => { window.dataLayer = window.dataLayer || []; window.dataLayer.push({ event: 'cta_quote', site_section: document.title.split('|')[0].trim(), site_sub_section: 'How It Works' }); }}><Calculator className="size-5" />Get A Real Quote In Minutes!</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-dark-blue text-white">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button asChild size="lg" variant="cta">
              <Link href="/quote" onClick={() => { window.dataLayer = window.dataLayer || []; window.dataLayer.push({ event: 'cta_quote', site_section: document.title.split('|')[0].trim(), site_sub_section: 'Get Started' }); }}><Calculator className="size-5" />Get A Real Quote In Minutes!</Link>
            </Button>
