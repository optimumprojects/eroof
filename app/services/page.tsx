...
const services = [
  { id: 'shingles', name: 'Asphalt Shingle Replacement', description: 'Complete roof replacement with high-quality asphalt shingles. Our most popular service offering excellent value, durability, and weather protection for Hamilton homes.', priceRange: '$7,500 - $12,000', timeline: '1 Day Installation', warranty: '25 Years Material + 10 Years Workmanship', image: 'https://static.wixstatic.com/media/b690e6_583e75f6299e4c6593b457def92d2852~mv2.png', features: ['Complete tear-off and disposal','Premium asphalt shingles','New underlayment and flashing','Ventilation assessment','Gutter cleaning included'], badge: { label: 'Most Popular', color: 'bg-action-orange text-black' } },
  { id: 'repairs', name: 'Roof Repairs', description: 'Professional roof repairs for leaks, damaged shingles, flashing issues, and storm damage. Emergency repairs available with same-day service.', priceRange: '$300 - $2,500', timeline: 'Same Day - 3 Days', warranty: '5 Years Workmanship', image: 'https://static.wixstatic.com/media/b690e6_ca6de0236e7844608dfb9b87bc621746~mv2.png', features: ['Emergency leak repairs','Shingle replacement','Flashing repair/replacement','Chimney and vent sealing','Storm damage assessment'], badge: { label: 'Emergency Service', color: 'bg-red-500 text-white' } },
  { id: 'skylights', name: 'Skylights', description: 'Professional skylight installation and replacement. Add natural light to your home while maintaining energy efficiency and weather protection.', priceRange: '$800 - $2,200', timeline: '4-6 Hours', warranty: '10 Years Product + 5 Years Installation', image: 'https://static.wixstatic.com/media/b690e6_efe16e5e94b1425289d0291fcbeb7711~mv2.png', features: ['Energy-efficient models','Proper flashing installation','Interior finishing','Ventilation options available','Custom sizing available'] },
  { id: 'ventilation', name: 'Roof Ventilation', description: "Proper roof ventilation systems to improve energy efficiency, prevent ice dams, and extend roof life. Essential for Hamilton's climate.", priceRange: '$400 - $1,500', timeline: '2-4 Hours', warranty: '10 Years Product + 5 Years Installation', image: 'https://static.wixstatic.com/media/b690e6_237655bb10144975874b7ce0632b00e0~mv2.png', features: ['Ridge vent installation','Soffit vent installation','Exhaust fan installation','Ventilation assessment','Energy efficiency improvement'] },
  { id: 'soffits-fascia', name: 'Soffits & Fascia', description: "Professional soffit and fascia installation and repair. Protect your roof edges and improve ventilation while enhancing your home's curb appeal.", priceRange: '$1,200 - $3,500', timeline: '1-2 Days', warranty: '20 Years Material + 10 Years Installation', image: 'https://static.wixstatic.com/media/b690e6_e8e46bc011f3446ea983fd0100ae7f8f~mv2.png', features: ['Vented and solid soffit options','Aluminum or vinyl fascia boards','Proper ventilation integration','Colour matching to existing trim','Seamless installation'] },
  { id: 'gutters', name: 'Gutter Systems', description: "Professional gutter installation, repair, and cleaning services. Protect your home's foundation and landscaping with proper water management.", priceRange: '$800 - $2,800', timeline: '4-8 Hours', warranty: '15 Years Material + 5 Years Installation', image: 'https://static.wixstatic.com/media/b690e6_e56147e9341d4570a0b0825f5ae0e819~mv2.png', features: ['Seamless aluminum gutters','Downspout installation','Gutter guards available','Proper slope calculation','Colour matching available'] },
]
              ...
              <div key={service.id} className={`grid lg:grid-cols-2 rounded-xl overflow-hidden border border-gray-200 ${index % 2 === 1 ? '' : ''}`}>
                ...
                <div className={`p-8 flex flex-col justify-center bg-dark-card ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    <span className="bg-white/10 text-white text-sm px-3 py-1 rounded">{service.priceRange}</span>
                    <span className="bg-white/10 text-white text-sm px-3 py-1 rounded">{service.timeline}</span>
                    <span className="bg-white/10 text-white text-sm px-3 py-1 rounded">{service.warranty}</span>
                  </div>
