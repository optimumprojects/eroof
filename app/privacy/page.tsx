...
const sections = [
  ...
  { title: '4. SMS Communications', body: 'If you provide your phone number and give express consent by ticking a consent checkbox on our forms, you consent to receive text messages from eRoof.ca. We ask for two consents separately and never bundle them: customer care messages about the estimate, appointment or project you asked us about; and, optionally and separately, promotional messages such as seasonal roofing tips and offers. Neither box is ticked by default, and you may accept either, both, or neither. Message frequency varies. Message and data rates may apply. Reply STOP to opt out at any time, or HELP for help. Consent to receive text messages is not a condition of purchase, and you can request and receive your estimate without opting in to any text messages.' },
